...
// Configure for this specific view (Life Notes)
const PAGE_TITLE = '生活随笔'
const PAGE_COVER = 'https://bu.dusays.com/2026/02/04/698346b3e9880.png'
...
<template>
  <div
    class="life-view min-h-screen bg-gray-50 dark:bg-[#1a1b26] text-gray-900 dark:text-[#c0caf5] font-sans transition-colors duration-300"
  >
    <Starry />
            ...
            >
              ...
              >
                ...
                <div class="absolute top-4 left-4 flex flex-wrap gap-2">
                  <span
                    class="px-3 py-1 text-xs font-bold bg-green-500/90 text-white rounded-lg backdrop-blur-sm shadow-lg"
                  >
                    {{ article.cateList?.[0]?.name || '生活随笔' }}
                  </span>
                </div>
              </div>
              ...
              <div class="flex-1 p-6 flex flex-col justify-between">
                <div>
                  ...
                  <h3
                    class="text-lg font-bold mb-3 group-hover:text-green-500 transition-colors line-clamp-2 cursor-pointer"
                    @click="viewArticle(article.id)"
                  >
                    {{ article.title }}
                  </h3>
                ...
                <div class="flex items-center justify-end mt-auto">
                  <button
                    ...
                    class="px-5 py-2 text-xs font-bold bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400 rounded-lg hover:bg-green-600 hover:text-white transition-all"
                  >
                    阅读全文
                  </button>
                </div>
